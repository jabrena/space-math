...
fillCircle(xmin + SCR_SUN_RADIUS + SUN_MERCURY_DISTANCE_MILL_KM,
           ymax / 2, SCR_MERCURY_RADIUS)

scr.setColor(VENUS_COLOR)
fillCircle(xmin + SCR_SUN_RADIUS + SUN_VENUS_DISTANCE_MILL_KM,
           ymax / 2, SCR_VENUS_RADIUS)

scr.setColor(EARTH_COLOR)
fillCircle(xmin + SCR_SUN_RADIUS + SUN_EARTH_DISTANCE_MILL_KM,
           ymax / 2, SCR_EARTH_RADIUS)

scr.setColor(MARS_COLOR)
fillCircle(xmin + SCR_SUN_RADIUS + SUN_MARS_DISTANCE_MILL_KM +
           10, ymax / 2, SCR_MARS_RADIUS)
